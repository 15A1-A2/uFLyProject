...
return array(
    ...
    "FEEDBACK_DOCUMENT_UPLOAD_WRONG_TYPE" => "Only PDF and DOC files are supported.",
    "FEEDBACK_DOCUMENT_UPLOAD_TOO_BIG" => "Document source file is too big. 5 Megabyte is the maximum.",
);
