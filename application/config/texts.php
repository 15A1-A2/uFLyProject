...
return array(
    ...
    "FEEDBACK_ACCOUNT_USER_SUCCESSFULLY_RANKED" => "The rank of the selected user has been changed successfully ",
    "FEEDBACK_DOMAIN_ADDED_SUCCESSFULLY" => "Domain has been added with success",
    ...
    "FEEDBACK_DOMAIN_ALREADY_TAKEN" => "You already added this domain",
